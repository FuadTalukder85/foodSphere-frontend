...
const Footer = () => {
  return (
    <div className="bg-[#1E2436] text-white">
      <Container>
        <footer className="footer grid grid-cols-12 gap-10 text-white py-16">
          <aside className="col-span-4">
            ...
            <button className="border-2 border-[#e7c14d] px-6 py-2 rounded-lg mt-6 font-bold">
              Donate Now
            </button>
          </aside>
          <nav className="col-span-2">
            <h6 className="font-bold text-2xl text-[#e7c14d]">Services</h6>
          ...
          <nav className="col-span-3">
            <h6 className="font-bold text-2xl text-[#e7c14d]">Non profit</h6>
          ...
          <nav className="col-span-4">
            <h6 className="font-bold text-2xl text-[#e7c14d]">Contact</h6>
            <p className="text-lg">
              380 Street Kilda Broklyn Road Melbourne Australia
            </p>
            <p className="flex gap-3 justify-center items-center text-lg">
              <FaEnvelope className="text-[#e7c14d] text-xl"></FaEnvelope>
              foodSphere@gmail.com
            </p>
            <p className="flex gap-3 justify-center items-center text-lg">
              <IoIosCall className="text-[#e7c14d] text-2xl"></IoIosCall>+ 98
              (000) - 9630
            </p>
            <p className="mt-1 flex gap-3">
              <button className="bg-[#00715D] w-[40px] h-[40px] flex items-center justify-center rounded-full">
                <FaFacebook className="text-[#e7c14d] text-xl"></FaFacebook>
              </button>
              <button className="bg-[#00715D] w-[40px] h-[40px] flex items-center justify-center rounded-full">
                <FaInstagram className="text-[#e7c14d] text-xl"></FaInstagram>
              </button>
              <button className="bg-[#00715D] w-[40px] h-[40px] flex items-center justify-center rounded-full">
                <FaTwitter className="text-[#e7c14d] text-xl"></FaTwitter>
              </button>
              <button className="bg-[#00715D] w-[40px] h-[40px] flex items-center justify-center rounded-full">
                <SlSocialPintarest className="text-[#e7c14d] text-xl"></SlSocialPintarest>
              </button>
            </p>
          </nav>
        </footer>
